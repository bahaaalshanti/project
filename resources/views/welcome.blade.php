...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html">BA<i>TI</i>.</a>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/002.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-12 ftco-animate">
            <h2 class="subheading">Hello! Welcome to</h2>
            <h6 class="mb-4 mb-md-0">BATI blog</h6>
            <div class="row">
                <div class="col-md-7">
                    <div class="text">
                        <p>On Monday, Manchester City's Premier League match at Everton was postponed four hours before kick-off at Goodison Park because of an outbreak of coronavirus at the club.</p>
                        <div class="mouse">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                  <a class="img mr-4 rounded" style="background-image: url({{asset('storage/'.$post->image)}});"></a>
                  <div class="text">
                    <h3 class="heading"><a href="#"> about</a></h3>
                    <div class="meta">
                      <div><a href="#"></span> Oct. 15, 2020</a></div>
                      <div><a href="#"></span> Admin</a></div>
                      <div><a href="#"></span> {{ $post->category->name }}</a></div>
                    </div>
                  </div>
                </div>
                <div class="block-21 mb-4 d-flex">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><a href="http://127.0.0.1:8000/login" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Home</a></li>
